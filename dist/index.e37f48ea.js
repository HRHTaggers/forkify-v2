...
const controlServings = function(noServings) {
    ...
    _model.updateServings(noServings);
    //Update recipe view
...
},{"core-js/modules/web.immediate.js":"49tUX","./model":"Y4A21","./views/recipeView":"l60JC","./views/searchView":"9OQAM","regenerator-runtime/runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./views/resultsView":"cSbZE","regenerator-runtime":"dXNgZ","./views/paginationView":"6z7bi","./views/bookmarksView":"4Lqzq","./views/addRecipeView":"i6DNj","./config":"k5Hzs"}],"49tUX":[function(require,module,exports) {
...
const updateServings = function(noServings) {
...
const API_KEY = `ce490b8c-c528-4704-b46c-39a5b3838d49`;
    ...
    _generateMarkup() {
        return `
            ...
            return `
                        ...
                        <div class="recipe__quantity">${(0, _fractyDefault.default)(ing.quantity).toString()}</div>
...
class View {
    ...
    update(data) {
        ...
        newElements.forEach((newElements, i)=>{
            ...
            if (!newElements.isEqualNode(currentEl) && newElements.firstChild?.nodeValue.trim() !== ``) currentEl.textContent = newElements.textContent;
            if (!newElements.isEqualNode(currentEl)) Array.from(newElements.attributes).forEach((attribute)=>currentEl.setAttribute(attribute.name, attribute.value));
        });
    }
    _clear() {
...
},{"./View":"5cUXS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fA0o9","aenu9"], "aenu9", "parcelRequire75d4")
